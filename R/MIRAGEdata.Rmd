...
clinical_var <- list(
  ...
  c("rd_ss2kg_ffm_insulin_pre", bquote(bold("Rate of glucose disposal")), .7),
...
clinical_var_post <- list(
  ...
  c("rd_ss2kg_ffm_insulin_post", bquote(bold("Rate of glucose disposal (post)")), .7),
...
clinical_var <- list(
  ...
  c("rd_ss2kg_ffm_insulin_pre", bquote("Rate of glucose disposal"), .7),
...
clinical_var_post <- list(
  ...
  c("rd_ss2kg_ffm_insulin_post", bquote("Rate of glucose disposal (post)"), .7),
...
# Selected clinical  
clinical_vars <- list(
  c("rd_ss2kg_ffm_insulin_pre", bquote(atop(NA, atop(textstyle(bold("Rate of glucose disposal")), textstyle( "mg ·(min·kgFFM·ins)"^{-1}))))),
...
filter_lipid_group_row <- function(data_frame, lipid_group) {
  ...
  # Sort the dataframe by the temporary lipid column
  sorted_data_frame_with_lipid <- data_frame_with_lipid# data_frame_with_lipid[order(data_frame_with_lipid$lipid), ]
