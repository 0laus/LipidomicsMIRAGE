...
label(mirage_included$rd_ss2kg_ffm_insulin_pre) <- "GIR/Iᵇ"
label(mirage_included$tdpa_pre) <- "Physical activity"
...
label(mirage_included$percent_imat_pre) <- "Thigh IMATᵃ"
...
# Footnote
footnote <-paste0 ("ᵃ Glucose infusion rate normalized to fat-free mass and blood insulin<br/>", # <br/> used as linebreak for html table
                   # "ᵇ Intramuscular adipose tissue<br/>",
                   "ᵇ Minutes of daily physical activity above 1.5 metabolic equavalent of task (MET)")
