...
plot <- ggplot(filtered_data, aes(
  ...
  filename <- paste0(
    getwd() ,"/outputs/saturation/pre-post/",
    save_folder, "/",
...
### Heat map
```{r}
pvals_df <- est_and_p_sat$p.vals
estimates_df <- est_and_p_sat$estimates
sat_type <- "sat_proportion"
...
pdf_path <- paste0( getwd(), "/outputs/saturation/heatmap/heatmap.pdf")
...
## Make correlation statistics on change
