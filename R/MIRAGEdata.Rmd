...
# PE.PC is not analysed as a composition, but only as class
...
# Outlier rm
est_and_p_lipid_comp <- prepare_lipid_data_for_plotting(result.lipid.pre_post.class_comp.outlierRM)  
