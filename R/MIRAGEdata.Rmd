...
lipidomicsDF_saturation <- lipidomicsDF_saturation %>%
  rowwise() %>% 
  mutate(
    unsat_sat_ratio = sum(class_unsat1_pmol_mg, class_unsat2_pmol_mg, class_unsat1_pmol_mg, class_unsat4_pmol_mg, class_unsat5_pmol_mg, class_unsat6_pmol_mg,class_sat_pmol_mg, na.rm = TRUE) / sum(class_unsat1_pmol_mg, class_unsat2_pmol_mg, class_unsat1_pmol_mg, class_unsat4_pmol_mg, class_unsat5_pmol_mg, class_unsat6_pmol_mg,class_sat_pmol_mg, class_sat_pmol_mg, na.rm = TRUE),
ether_bond_ratio = class_ether_pmol_mg / sum(class_no_ether_pmol_mg, class_ether_pmol_mg, na.rm = TRUE)) %>% 
         ungroup()
...
result.lipid.pre_post_sat.class <- map(unique_lipid_classes, ~ mixedmodel_pre_post_sat(lipidomicsDF_saturation, "unsat_sat_ratio", .x))

# Naming the results list
names(result.lipid.pre_post_sat.class) <- unique_lipid_classes
